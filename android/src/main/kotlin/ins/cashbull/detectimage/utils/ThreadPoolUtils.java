package ins.cashbull.detectimage.utils;
...
public class ThreadPoolUtils {
    ...
    public static final ThreadPoolUtils defaultPool = new ThreadPoolUtils(ThreadEnum.FixedThread, 8);
    ...
    /**
     * 试图停止所有正在执行的活动任务
     * <p><center>[wp_ad_camp_3]</center></p><p>试图停止所有正在执行的活动任务，暂停处理正在等待的任务，并返回等待执行的任务列表。</p>
